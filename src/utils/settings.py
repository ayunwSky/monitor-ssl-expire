...
# 邮箱的配置
email_settings = {
    'APP_OPEN_EMAIL': os.getenv("APP_OPEN_EMAIL", "1开启邮件接收告警,0关闭邮件接收告警"),
    ...
    'APP_MAIL_RECEIVERS': os.getenv("APP_MAIL_RECEIVERS", "收件人邮箱，可以写多个，用逗号分隔")
}
...
dingtalk_settings = {
    ...
    'APP_DINGTALK_PHONE_MEMBER': os.getenv("APP_DINGTALK_PHONE_MEMBER", "钉钉群组接受被艾特的成员手机号，可以写多个，用逗号分隔")
}

# 飞书的配置
feishu_settings = {
    'APP_OPEN_FS': os.getenv("APP_OPEN_FS", "0"),
